...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Bola Brand — Premium Fashion Accessories" },
      {
        name: "description",
        content:
          "Premium handbags, elegant pouches and statement accessories for the modern woman.",
      },
      { name: "author", content: "The Bola Brand" },
      { property: "og:title", content: "The Bola Brand — Premium Fashion Accessories" },
      {
